...
if(isset($_POST['updbtn'])){
    ...
    $target_file = $derectory.$_FILES['admin_image']['name'];
        ...
        if(file_exists($target_file)){
            ...
            if($file_type!='jpg' && $file_type!='png'){
                ...
                if($file_size>500000){
                    ...
                    move_uploaded_file($_FILES['admin_image']['tmp_name'], $target_file);
                    $sql = "UPDATE registration_table SET image='$target_file' WHERE id='$quesSet_id'";
...
<div class="row justify-content-center mt-4">
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header mch" style="text-align: center;"><?php echo $_SESSION['quesSetName']; ?></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">
                                                ...
                                                <input type="hidden" name="hid" value="<?php echo $quesSet_id; ?>"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
